...
public class ObjectFactory {
    ...
    private final static QName _Convert_QNAME = new QName("http://wsp/", "Convert");
    private final static QName _ConvertResponse_QNAME = new QName("http://wsp/", "ConvertResponse");
    private final static QName _Compte_QNAME = new QName("http://wsp/", "compte");
    private final static QName _GetCompte_QNAME = new QName("http://wsp/", "getCompte");
    private final static QName _GetCompteResponse_QNAME = new QName("http://wsp/", "getCompteResponse");
    private final static QName _ListComptes_QNAME = new QName("http://wsp/", "listComptes");
    private final static QName _ListComptesResponse_QNAME = new QName("http://wsp/", "listComptesResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://wsp/", name = "Convert")
     ...
     */
    @XmlElementDecl(namespace = "http://wsp/", name = "ConvertResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://wsp/", name = "compte")
     ...
     */
    @XmlElementDecl(namespace = "http://wsp/", name = "getCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://wsp/", name = "getCompteResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://wsp/", name = "listComptes")
     ...
     */
    @XmlElementDecl(namespace = "http://wsp/", name = "listComptesResponse")
